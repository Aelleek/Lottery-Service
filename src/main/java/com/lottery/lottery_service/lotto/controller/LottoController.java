...
public class LottoController {
   ...
   * 로또 번호 추천 API
   *
   * <p>요청한 사용자(회원에게 로또 번호 5세트를 추천하고, 추천 받은 번호는 DB에 저장된다.
   *
   * <p>source 파라미터를 통해 추천 방식(BASIC, AD 등)을 구분하여 저장 시 이를 기록함으로써 추천 제한 및 분석에 활용할 수 있다.
   *
  ...
  public ResponseEntity<List<LottoSet>> recommendForMember(
