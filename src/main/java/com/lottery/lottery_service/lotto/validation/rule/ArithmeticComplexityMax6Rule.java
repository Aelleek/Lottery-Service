...
/**
 * AC(산술적 복잡도) <= 6 이면 FAIL.
 * - 정의: 정렬된 6개 수의 모든 (aj-ai) 차이값의 서로 다른 개수.
 * - 최근 데이터 기준 AC≤6은 드물지만 안전 장치로 하드컷.
 */
@Component
@Order(50)
public class ArithmeticComplexityMax6Rule implements LottoValidationRule {

    @Override public String id() { return "ArithmeticComplexityMax6"; }
    @Override public String reasonOnFail() { return "AC_LE_6"; }
