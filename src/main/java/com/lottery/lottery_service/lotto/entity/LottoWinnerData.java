 ...
 * <p>설계 포인트:
 * <ul>
 *   <li>PK는 회차 {@link #round}</li>
 *   <li>6개 당첨번호는 공백 구분 문자열 {@link #winnerData} 로 저장
 *       (예: "2 8 19 22 32 42")</li>
 *   <li>보너스 번호는 {@link #bnusNo}</li>
 *   <li>returnValue는 저장하지 않음</li>
 * </ul>
 */
@Entity
@Table(
        ...
        indexes = {
                @Index(name = "idx_lotto_winner_canonical", columnList = "winnerData")
        }
)
@Getter
@Setter
...
public class LottoWinnerData {
    ...
    /**
     * 당첨번호 6개를 오름차순으로 정렬한 canonical 문자열을 만들어 winnerData에 세팅한다.
     * 입력값이 null이면 NPE를 던진다.
     */
    public void setWinnerDataFromNumbers(Integer n1, Integer n2, Integer n3, Integer n4, Integer n5, Integer n6) {
