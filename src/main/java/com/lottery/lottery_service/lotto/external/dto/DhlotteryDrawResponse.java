 ...
 * <p>예시 응답:
 * {
 *   "totSellamnt":118628811000,"returnValue":"success","drwNoDate":"2022-01-29",
 ...
 *
 * <p>주의:
 * - 필드명은 API 스펙 그대로 사용하며, 엔티티 저장 시 가공/검증은 서비스 단계에서 수행.
 * - returnValue는 저장하지 않지만, 성공/미발표 판별을 위해 여기서는 유지.
 */
@Getter
@ToString
...
public class DhlotteryDrawResponse {
    ...
    /** 당첨 번호 1~6 */
    @JsonProperty("drwtNo1") private Integer drwtNo1;
    @JsonProperty("drwtNo2") private Integer drwtNo2;
    @JsonProperty("drwtNo3") private Integer drwtNo3;
    @JsonProperty("drwtNo4") private Integer drwtNo4;
    @JsonProperty("drwtNo5") private Integer drwtNo5;
